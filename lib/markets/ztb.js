...
function get_trades(coin, exchange, cb) {
  var req_url = base_url + '/api/v1/trades?symbol=' + coin.toUpperCase() + '_' + exchange.toUpperCase() + '&size=100';
...
function get_orders(coin, exchange, cb) {
  var req_url = base_url + '/depth?symbol' + coin.toUpperCase() + '_' + exchange.toUpperCase();
...
function get_chartdata(coin, exchange, cb) {
  ...
  var req_url = base_url + '/kline?symbol=' + coin.toUpperCase() + '_' + exchange.toUpperCase() + '&type=15min&size=100';
