...
const market_url_template = 'https://www.exbitron.com/trading/bteusdt';
...
function get_chartdata(coin, exchange, cb) {
  ...
  var req_url = base_url + '/public/markets/' + coin.toLowerCase() + exchange.toLowerCase() + '/k-line?period=60&limit=24';
