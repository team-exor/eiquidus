...
exports.markets_page = {
  ...
  //            Supported exchanges: dex-trade, dexomy, freiexchange/freixlite, nonkyc, poloniex, yobit
  "exchanges": {
    ...
    // nestex: a collection of settings that pertain to nestex
    "nestex": {
      // enabled: Enable/disable nestex (true/false)
      //          If set to false, nestex page will be completely inaccessible and no market data will be downloaded for this exchange
      "enabled": false,
      // trading_pairs: An array of market trading pair symbols
      //                You can add as many trading pairs as necessary
      //                All entries must specify your coins symbol as it is displayed on the exchange, followed by a slash (/) and ending with the symbol of the market or asset that is being traded against
